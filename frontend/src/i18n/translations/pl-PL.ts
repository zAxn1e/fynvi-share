export default {
  ...
  "home.bullet.a.description": "Utrzymuj Fynvi Share na własnym serwerze.",
  ...
  "admin.config.config-file-warning.description": "Ponieważ masz skonfigurowane Fynvi Share z plikiem konfiguracyjnym, nie możesz zmienić konfiguracji za pomocą interfejsu użytkownika.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Fynvi Share jest dostępny",
