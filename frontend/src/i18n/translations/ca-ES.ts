export default {
  ...
  "home.bullet.a.description": "Hostegeu Fynvi Share a la vostra pròpia màquina.",
  ...
  "admin.config.config-file-warning.description": "Com que teniu un Fynvi Share configurat amb un fitxer de configuració, no podeu canviar la configuració mitjançant la interfície d'usuari.",
  ...
  "admin.config.general.app-url.description": "En quina URL està disponible Fynvi Share",
  ...
  "admin.config.cache.redis-enabled.description": "Normalment, Fynvi Share emmagatzema la informació a la memòria. Si executeu diverses instàncies de Fynvi Share, heu d'activar la memòria cau de Redis per compartir-la entre instàncies.",
