export default {
  ...
  "home.bullet.a.description": "Hébergez Fynvi Share sur votre propre machine.",
  ...
  "upload.button.create": "Créer un partage",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré Fynvi Share avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.general.app-url.description": "Depuis quel URL le partage Fynvi est disponible",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, Fynvi Share conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de Fynvi Share, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
  ...
  "admin.config.oauth.oidc-role-path.description": "Doit être un chemin JMES valide référençant un tableau de rôles. ",
  "admin.config.oauth.oidc-role-general-access": "Rôle OpenID Connect pour un accès général",
  "admin.config.oauth.oidc-role-general-access.description": "Rôle requis pour un accès général. Doit être présent dans les rôles d'un utilisateur pour qu'il se connecte. ",
  "admin.config.oauth.oidc-role-admin-access": "Rôle OpenID Connect pour l'accès admin",
  "admin.config.oauth.oidc-role-admin-access.description": "Rôle requis pour l'accès administratif. Doit être présent dans les rôles d'un utilisateur pour accéder au panneau d'administration. ",
  ...
  "common.button.signIn": "Se connecter",
  "common.button.signUp": "S’inscrire",
  "common.button.signOut": "Se déconnecter",
  "upload.button.select-files": "Sélectionner des fichiers",
  "upload.button.select-folder": "Sélectionner un dossier",
  "upload.dropzone.subtitle": "Prise en charge de tous les types de fichiers, dossiers et collage depuis le presse-papiers (Ctrl+V)",
  "upload.notify.max-size-limit": "La taille totale des fichiers dépasse la limite maximale de {size}",
  "common.error.field-required": "Ce champ est obligatoire",
  "signup.input.password": "Mot de passe",
  "signup.input.password.placeholder": "Votre mot de passe",
  "signin.button.signin": "Se connecter",
  "signin.button.forgot-password": "Mot de passe oublié ?",
