export default {
  ...
  "home.bullet.a.description": "Isännöi \\\"Fynvi Share\\\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Fynvi Share on saatavilla",
