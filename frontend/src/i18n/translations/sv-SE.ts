export default {
  ...
  "home.bullet.a.description": "Hosta Fynvi Share på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad Fynvi Share med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL Fynvi Share finns",
  ...
  "admin.config.cache.redis-enabled.description": "Normalt sett cachar Fynvi Share information i minnet. Om du kör flera instanser av Fynvi Share måste du aktivera Redis-cachning för att dela cachen mellan instanserna.",
