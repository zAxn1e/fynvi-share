export default {
  ...
  "home.bullet.a.description": "Hospede o Fynvi Share em sua própria máquina.",
  ...
  "upload.button.create": "Criar compartilhamento",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Fynvi Share configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Fynvi Share está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Fynvi Share na memória. Se você executar várias instâncias do Fynvi Share, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
  ...
  "admin.config.oauth.oidc-role-path.description": "Deve ser um caminho JMES válido, fazendo referência a uma matriz de funções. ",
  "admin.config.oauth.oidc-role-general-access": "Função OpenID Connect para acesso geral",
  "admin.config.oauth.oidc-role-general-access.description": "Função necessária para acesso geral. Deve estar presente nas funções de um usuário para que ele faça o login. ",
  "admin.config.oauth.oidc-role-admin-access": "Função OpenID Connect para acesso de administrador",
  "admin.config.oauth.oidc-role-admin-access.description": "Função necessária para acesso administrativo. Deve estar presente nos papéis de um usuário para ele acessar o painel de administração. ",
  ...
  "common.button.signIn": "Iniciar sessão",
  "common.button.signUp": "Cadastre-se",
  "common.button.signOut": "Terminar sessão",
  "upload.button.select-files": "Selecionar arquivos",
  "upload.button.select-folder": "Selecionar pasta",
  "upload.dropzone.subtitle": "Suporte a qualquer tipo de arquivo, pastas e colar da área de transferência (Ctrl+V)",
  "upload.notify.max-size-limit": "O tamanho total dos arquivos excede o limite máximo de {size}",
  "common.error.field-required": "Este campo é obrigatório",
  "signup.input.password": "Senha",
  "signup.input.password.placeholder": "Sua senha",
  "signin.button.signin": "Iniciar sessão",
  "signin.button.forgot-password": "Esqueceu a sua senha?",
