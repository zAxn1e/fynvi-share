export default {
  ...
  "admin.config.config-file-warning.description": "由於您已使用設定檔配置 Fynvi Share，因此無法透過介面變更設定。",
  ...
  "admin.config.general.app-url.description": "Fynvi Share 的 URL",
  ...
  "admin.config.cache.redis-enabled.description": "預設情況下，Fynvi Share 會將資訊快取於記憶體中。若您執行多個 Fynvi Share 執行個體，則需要啟用 Redis 快取，讓各個執行個體共用快取資料。",
