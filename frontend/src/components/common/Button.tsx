import { Button as MantineButton, ButtonProps as MantineButtonProps, CSSObject } from "@mantine/core";
import React, { forwardRef } from "react";

export interface ButtonProps extends MantineButtonProps {
  variant?: "primary" | "secondary" | "subtle" | "ghost" | "danger" | "warning" | "glass";
  component?: any;
  href?: string;
  target?: string;
  download?: string;
      ...
      <MantineButton
        ...
        sx={[
          (theme): CSSObject => {
            ...
            if (variant === "primary") {
              customStyles = {
                background: "var(--brand-gradient-vertical, var(--brand-gradient, linear-gradient(180deg, #3B82F6 0%, #2563EB 100%)))",
                color: "#FFFFFF",
                ...
                "&:active": {
                  ...
                  boxShadow: "0 1px 2px rgba(0, 0, 0, 0.2), inset 0 1px 2px rgba(0, 0, 0, 0.2)",
                },
              };
              ...
              customStyles = {
                ...
                backgroundImage: "linear-gradient(180deg, rgba(255, 255, 255, 0.06) 0%, rgba(255, 255, 255, 0.01) 100%)",
              ...
              customStyles = {
                backgroundColor: isDark ? "var(--state-danger-bg, rgba(239, 68, 68, 0.12))" : "#FEE2E2",
                color: isDark ? "#F87171" : "#DC2626",
                border: isDark ? "1px solid rgba(239, 68, 68, 0.3)" : "1px solid rgba(220, 38, 38, 0.2)",
                "&:hover": {
                  backgroundColor: isDark ? "rgba(239, 68, 68, 0.25)" : "#FCA5A5",
                },
              };
            } else if (variant === "warning") {
              customStyles = {
                backgroundColor: isDark ? "var(--state-warning-bg, rgba(245, 158, 11, 0.12))" : "#FEF3C7",
                color: isDark ? "#FBBF24" : "#D97706",
                border: isDark ? "1px solid rgba(245, 158, 11, 0.3)" : "1px solid rgba(217, 119, 6, 0.2)",
                "&:hover": {
                  backgroundColor: isDark ? "rgba(245, 158, 11, 0.25)" : "#FDE68A",
                },
              };
            }
